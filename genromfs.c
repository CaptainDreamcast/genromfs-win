...
#include <stdint.h>
#include <io.h> /* Userland prototypes of the Unix std system calls    */
...
//	}
		...
		fd = _open(node->realname, O_RDONLY
#ifdef O_BINARY
			| O_BINARY
#endif
		);
